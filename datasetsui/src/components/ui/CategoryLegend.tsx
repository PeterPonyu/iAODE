  ...
  if (compact) {
    return (
      <div className="flex flex-wrap items-center gap-3">
        {showTitle && (
          <span className="flex items-center gap-1.5 text-xs font-semibold text-[rgb(var(--muted-foreground))] transition-colors">
        ...
        {categories.map((cat) => {
          ...
          return (
            ...
            >
              ...
              />
              <span className="text-xs font-medium capitalize text-[rgb(var(--foreground))] transition-colors">
                {info.label}
              </span>
            </div>
          );
        ...
        {categories.map((cat) => {
          ...
          return (
            ...
            >
              <span
                className={cn(
                  'inline-flex items-center justify-center w-10 h-10 rounded-lg border-2 text-base font-bold flex-shrink-0 transition-all group-hover:scale-110',
                  colors.bg,
                  colors.text,
                  colors.border
                )}
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-semibold capitalize text-[rgb(var(--foreground))] transition-colors">
                  {info.label}
                </p>
