    ...
    <div className="w-full">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20">
        ...
        <section className="text-center mb-16 sm:mb-20">
          ...
          <Link
            href="/explorer"
            className="inline-block px-8 py-3.5 bg-[rgb(var(--primary))] text-[rgb(var(--primary-foreground))] rounded-lg font-medium hover:opacity-90 transition-opacity shadow-sm"
          >
            Launch Explorer
          </Link>
        </section>
        ...
        {/* About */}
        <section className="bg-[rgb(var(--muted))] rounded-xl p-6 sm:p-8">
...
function FeatureCard({ title, description }: { title: string; description: string }) {
  return (
    <div className="p-6 rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--background))] hover:shadow-md transition-shadow">
